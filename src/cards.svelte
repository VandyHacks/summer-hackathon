...
const card_data = [
  ...
  {
    'title': 'Nashville Entrepreneurship Center',
    ...
    'details': 'Nashville Entrepreneurship Center works towards building a robust entrepreneurial network in Nashville. The project they need help with is building a centralized database of resources and an automated recommendation system for local start-ups.',
  },
  {
